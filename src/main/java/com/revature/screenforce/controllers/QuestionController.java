...
/**
 * Controller that handles mapping for all of the methods for question
 * manipulation
 * 
...
public class QuestionController {
	 ...
	 */
	@ApiOperation(value = "Get all questions", response = Question.class, responseContainer = "List")
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Question found"),
	 ...
	 * 
	 *         For the getByCategory method, it should be done using a params.
	 *         rather than an endpoint.
	 */
	@ApiOperation(value = "Find list of Questions by categoryId", notes = "Each question belongs to a particular category that classifies subject matter", response = Question.class, responseContainer = "List")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Success, categoryId found with Question Associated"),
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "categoryId found, deleted all question"),
			@ApiResponse(code = 404, message = "categoryId is not found") })
